...
var modalWindow = document.querySelector('.lightbox');
var closeBtn = document.querySelector('button');
var closeBackdrop = document.querySelector('div.lightbox__overlay');
...
var imageModalWindow = document.querySelector('img.lightbox__image');
